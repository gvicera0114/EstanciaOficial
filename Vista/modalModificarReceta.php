...
<!-- Modal -->
<div class="modal fade" id="recetaModificar" tabindex="-1" aria-labelledby="recetaModificar" aria-hidden="true">
  <div class="modal-dialog modal-lg  modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="modalReceta">Modificar receta</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
     
    <div class="modal-body">

        <h1 class="modal-title fs-5 title-separator" id="recetaModificar">Ingrese el diagnostico del paciente</h1>

        <form action="index.php?accion=actualizarReceta" method="POST">
